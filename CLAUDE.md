...
- Dev_PuzzleTest 배치: 상단 카드 시드 / **허수아비 3마리(가운데, 왼쪽부터 순번 0·1·2)** / 연결 기록, 보드 왼쪽 메인 캐릭터, **보드 오른쪽 보석 분포**(허수아비와 자리 바꿈, 사용자 요청).
...
- [ ] 9일차 동일 종류 연속 +20%·4연속 강공격·5연속 특수 보석 (제거·낙하·보충은 7일차에 완료)
- [ ] 10일차 피버 + 퍼즐 검증
...
- **9일차 전**: 연속 보너스 상한, 강공격 배율, 특수 보석 종류·효과
